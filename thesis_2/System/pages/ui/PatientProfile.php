                                ...
                                <form class="form-horizontal page-content" form method="POST" action="savepatient.php">
                                    ...
                                    <div class="row clearfix demo-masked-input">
                                        ...
                                        <div class="col-lg-2 col-md-1 col-sm-2 col-xs-3">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="date" class="form-control" name="birthdate" id="birthdate" value="<?php echo $fetch['P_BirthDate']?>" style="padding-right:0" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 form-control-label">
                                    ...
                                    <div class="row clearfix  demo-masked-input">
                                        ...
                                        <div class="col-lg-2 col-md-1 col-sm-2 col-xs-4">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="date" class="form-control" name="DIDS" id="DIDS" placeholder="YYYY/MM/DD" style="padding-right:0" value="<?php echo $fetch['P_InDial']?>" required>
                                                </div>
                                            </div>
                                        </div>
