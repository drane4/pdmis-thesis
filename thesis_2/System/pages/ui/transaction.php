                                  ...
                                  <hr>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-7 col-xs-offset-7">
                                            <button type="button" class="btn btn-primary m-t-15 waves-effect" data-toggle="modal" data-target="#smallModal"> <i class="material-icons">mode_edit</i>Update</button> &nbsp;
