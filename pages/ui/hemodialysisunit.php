                    ...
                    <ul class="list">
                       ...
                       <li id="profile" class="active">
                            ...
                            <ul class="active" class="ml-menu">
                                ...
                                <li id="hemodialysisunit" class ="active">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form class="form-horizontal" form method="POST" action="saveuser.php">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-1 col-xs-1 ">
                                         ...
                                         <div class="row clearfix">
                                        <div class="col-md-2 col-sm-5 col-xs-4 form-control-label">
                                            <label>General Data and Patient Profile:</label>
                                        </div>
                                        <div class="col-lg-9 col-md-4 col-sm-1 col-xs-1 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                   <input type="text" class="form-control" value=" " name="employeeid" value="" id="employeeid" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row " style="margin-left: 185px;">
                                        <div class="col-lg-5 col-md-1 col-sm-1 col-xs-4 form-control-label" style="margin-left: -158px;">
                                            <label>Past History (Previous Illness & Operationg):</label>
                                        </div>
                                             <div class="form-group input-group">
                                            <input type="checkbox" id="dm_a" name="dm_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'dm_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="dm_a">DM</label>         
                                            </div>
                                            <div class="form-group input-group">       
                                          <input type="checkbox" id="hpn_a" name="hpn_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'hpn_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="hpn_a">HPN</label>   
                                             </div>
                                              <div class="form-group input-group">
                                         <input type="checkbox" id="ptb_a" name="ptb_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'ptb_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="ptb_a">PTB</label>   
                                            </div>
                                              <div class="form-group input-group"> 
                                            <input type="checkbox" id="asthma_a" name="asthma_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'asthma_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="asthma_a">Asthma</label>
                                             </div>   
                                              <div class="form-group input-group"> 
                                            <input type="checkbox" id="other_a" name="other_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'other_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="other_a">Others</label>
                                             </div>  
                                        </div>
                                       
                                       <div class="row " style="margin-left: 600px; margin-top: -180px;">
                                        <div class="col-lg-6 col-md-1 col-sm-1 col-xs-4 form-control-label" style="margin-left: -100px; margin-top:-20px;">
                                            <label>Personal/Social History:</label>
                                        </div>
                                             <div class="form-group input-group">
                                            <input type="checkbox" id="alcoholintake_a" name="alcoholintake_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'alcoholintake_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="alcoholintake_a">Alcohol Intake</label>         
                                            </div>
                                            <div class="form-group input-group">       
                                          <input type="checkbox" id="smokinghistory_a" name="smokinghistory_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'smokinghistory_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="smokinghistory_a">Smoking History</label>   
                                            </div>
                                              <div class="form-group input-group">  
                                            <input type="checkbox" id="drugallergies_a" name="labtest_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'drugallergies_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="drugallergies_a">Drug Allergies</label>        
                                            </div>
                                              <div class="form-group input-group">
                                         <input type="checkbox" id="foodallergies_a" name="foodallergies_a" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'foodallergies_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="foodallergies_a">Food Allergies</label>   
                                            </div>
                                              <div class="form-group input-group"> 
                                            <input type="checkbox" id="others_a" name="others_aa" class="filled-in" value="1"
                                                   <?php if ($fetch[ 'others_a']==1 ){?> checked="checked"<?php } ?>/>
                                            <label for="others_a">Others</label>
                                             </div>   
