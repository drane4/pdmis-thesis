...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 11:12 PM
...
(43, '2018-02-28', '170', 'test', 'R AVF', '1230', 1, '12-12-12 ', '50', 'E0001', 'E00010', '40', '4:08 am', '10:43 am', 75, 'HIPS-18'),
(44, '2018-02-28', '300cc', '1st reuse', 'R AVF', '2500 iu', 7, 'AAA-AAA ', '83', 'E0001', 'E00010', '80', '11:01 am', '11:51 am', 75, 'HIPS-18');
...
--
ALTER TABLE `confinement`
  MODIFY `confinement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `employeeprofile`
  MODIFY `employee_num` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `hepatitisbvaccine`
  MODIFY `hepa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `hepatitisprofile`
--
ALTER TABLE `hepatitisprofile`
  MODIFY `hepatitisprofile_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `influenzavaccine`
--
ALTER TABLE `influenzavaccine`
  MODIFY `influenza_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `initialtestresult`
--
ALTER TABLE `initialtestresult`
  MODIFY `initialtestresult_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `laboratory_info`
  MODIFY `labinfo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `machineresult`
  MODIFY `machineresult_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `nephronotesorder`
  MODIFY `notes_order_Id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `nursenotes`
--
ALTER TABLE `nursenotes`
  MODIFY `nurse_notes_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `patientdrugprofile`
--
ALTER TABLE `patientdrugprofile`
  MODIFY `drugprofile_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `patientschedule`
--
ALTER TABLE `patientschedule`
  MODIFY `schedule_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `pneumococcal_vaccine`
--
ALTER TABLE `pneumococcal_vaccine`
  MODIFY `pneumococcal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `problemlist`
--
ALTER TABLE `problemlist`
  MODIFY `problemlist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `treatment`
--
ALTER TABLE `treatment`
  MODIFY `treatment_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
