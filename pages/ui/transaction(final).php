                                ...
                                <form class="form-horizontal" form method="POST" action="saveuser.php">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-1 col-xs-1 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" placeholder=" <?php echo $fetch['P_Fname'].' '.$fetch['P_Mname'].' '.$fetch['P_Lname']?>" name="employeeid" value="" id="employeeid" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-1 col-md-2 col-sm-1 col-xs-1 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="employeeid" value="" placeholder="<?php echo $fetch['P_Age']?>" id="employeeid" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-sm-5 col-xs-4 form-control-label">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-1 col-xs-1 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="employeeid" value="" placeholder="<?php echo $fetch['P_Sex']?>" id="employeeid" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-sm-5 col-xs-4 form-control-label">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-1 col-xs-1 ">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="employeeid" value="" placeholder="<?php echo $fetch['P_CivilStatus']?>" id="employeeid" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <table id="mainTable" class="table table-bordered" style="margin-bottom: 0px; cursor: pointer;">
    ...
    ?>    
                                                <tbody>
                                                    <?php   
                                                            ...
                                                            $date = date("Y-m-d");
                                                            $conn = new mysqli("localhost", "root", "", "PDMIS") or die(mysqli_error());
                                                           $query = $conn->query("SELECT * FROM `nephronotesorder` WHERE `notes_order_date` = '$date' ORDER BY `notes_order_id`") or die(mysqli_error());
                                                           $id = $fetch['Hospital_Id'];
                                                        ...
                                                        <tr>
                                                            <td>
                                                             <a href="#editPhysician_notes" data-toggle="modal" data-target="#editPhysician_notes" style="color: black;">
                                                                ...
                                                                <b><?php echo " -".$n_fname." ".$n_mname." ".$n_lname?></b>
                                            ...
                                            <table id="mainTable" class="table table-bordered" style="margin-bottom: 0px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                            $date = date("Y-m-d");
                                                            $conn = new mysqli("localhost", "root", "", "PDMIS") or die(mysqli_error());
                                                           $query = $conn->query("SELECT * FROM `initialtestresult` WHERE `initialtest_date` = '$date' ORDER BY `initialtestresult_id`") or die(mysqli_error());
                                                           $id = $fetch['Hospital_Id'];
                                            ...
                                            <table id="mainTable" class="table table-bordered" style="margin-bottom: 0px; table-layout: fixed;">
                                                ...
                                                <tbody>
                                                    <?php
                                                            $date = date("Y-m-d");
                                                            $conn = new mysqli("localhost", "root", "", "PDMIS") or die(mysqli_error());
                                                           $query = $conn->query("SELECT * FROM `nursenotes` WHERE `nurse_notes_date` = '$date' ORDER BY `nurse_notes_id`") or die(mysqli_error());
                                                           $id = $fetch['Hospital_Id'];
                                            ...
                                            <table id="mainTable" class="table table-bordered" style="margin-bottom: 0px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                            $date = date("Y-m-d");
                                                            $conn = new mysqli("localhost", "root", "", "PDMIS") or die(mysqli_error());
                                                           $query = $conn->query("SELECT * FROM `machineresult` WHERE `m_date` = '$date' ORDER BY `machineresult_id`") or die(mysqli_error());
                                                           $id = $fetch['Hospital_Id'];
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-7 col-xs-offset-7">
                                             <a href="#smallModal" data-toggle="modal" data-target="#smallModal" class="btn btn-primary m-t-15 waves-effect"><i class="material-icons">mode_edit</i>Update</a>&nbsp;
                                        ...
                                        <div class="body">
                                            ...
                                            ?>
                                                    <div role="tabpanel" class="tab-pane fade in active" id="physician">
                                                        ...
                                                        <form class="form-horizontal" form method="POST" action="savehemotreatment.php?id=<?php echo $_GET[id]?>">
                                                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                        <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                                <li role="presentation" class="disable"><a href="#physician" data-toggle="tab">Physicians Notes/Order</a></li>
                                                <li role="presentation" class="active"><a>Nurses Notes</a></li>
                                                <li role="presentation" class="disabled"><a>Initial Test</a></li>
                                                <li role="presentation" class="disabled"><a>Machine Result</a></li>
                                            </ul>
                                             <!-- Tab panes -->
