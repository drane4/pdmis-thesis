...
<?php include ('modals/dialysisreport_modal.php')?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header bg-indigo">
                                <h2>
                                    Hemodialysis Cause of ESRD Statistics
                                </h2>
                            </div>
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                                 ...
                                                 <button style="" type="button" class="btn btn-primary" data-toggle="modal" data-target="#patients">Find</button>
                                            ...
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="bp_report.php?id=<?php echo $fetch['Hospital_Id']?>">
        ...
        <?php require 'js/charteasy/bloodpressure.php'?>
