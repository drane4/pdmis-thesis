            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $name; ?>
                                            ...
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    $date = date("Y-m-d H:i:s"); 
                                                           ...
                                                           $query = $conn->query("SELECT * FROM `activitylog` INNER JOIN `employeeprofile`
                                                           ON `activitylog`.`employeeid` = `employeeprofile`.`employeeid`") or die(mysqli_error());
