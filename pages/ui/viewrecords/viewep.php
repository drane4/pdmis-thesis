                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#userprofile">User Profile</a>
                                </li>
                                <li>
                                ...
                                <form class="form-horizontal page-content" form method="POST" action="save.php">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-6 col-xs-offset-3">
                                            <button type="button" class="btn btn-primary m-t-15 waves-effect" onclick="window.location.href='../EP.php'"> <i class="material-icons">description</i> New</button> &nbsp;
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="viewep.php?id=<?php echo $fetch['employeeid']?>">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                           <div class="row clearfix">
                                        <div class="col-md-3 col-sm-3 col-xs-4 form-control-label" >
                                            <label>Employee ID</label>
                                        </div>
                                        <div class="col-lg-3 col-md-1 col-sm-2 col-xs-3">
                                            <select class="form-control show-tick" name="employeeid" id="employeeid">
                                                <option value="Nurse">E0001</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <form class="form-horizontal page-content" form method="POST" action="save.php">
                                       <div class="row clearfix">
                                        ...
                                        <div class="col-lg-3 col-md-1 col-sm-2 col-xs-3 col-md-3  form-control-label">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" id="lastname" name="lastname" class="form-control" placeholder="" value="<?php echo $fetch['lastname']?>" onkeyup="capitalize(this.id, this.value);" autofocus required>
                                                </div>
                                            </div>
                                        </div>     
                                    </div>                   
                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="col-lg-8 col-md-1 col-sm-2 col-xs-3 col-md-3  form-control-label">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="lastname" name="lastname" class="form-control" placeholder="" value="<?php echo $fetch['lastname']?>" onkeyup="capitalize(this.id, this.value);" autofocus required>
                                                </div>
                                      ...
                                      <div class="row clearfix ">
                                        <div class="form-group demo-radio-button  col-md-3 col-sm-2 col-xs-3">
                                           
                                            <input name="type1" type="radio" class="with-gap" id="radio_3" value="1" checked="active"
                                                   <?php if ($fetch[ 'dialysistype']==0 ){?> checked="active"<?php } ?>/>
                                            <label for="radio_3" >Nurse</label>
                                            <input name="type1" type="radio" id="radio_4" class="with-gap" value="2"
                                                    <?php if ($fetch[ 'dialysistype']==1 ){?> checked="active"<?php } ?>/>
                                            <label for="radio_4">Head Nurse</label>
                                            <input name="type1" type="radio" id="radio_5" class="with-gap" value="3"
                                                    <?php if ($fetch[ 'dialysistype']==1 ){?> checked="active"<?php } ?>/>
                                            <label for="radio_5">Administrator</label>
                                        </div>
                                                <hr>
