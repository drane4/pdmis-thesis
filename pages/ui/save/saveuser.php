...
if(ISSET($_POST['submit'])){
     ...
     $labtest_a = $_POST['labtest_a'];
     $nephrologist_a = $_POST['nephrologist_a'];
     $descriptors_a = $_POST['descriptors_a'];
...
if(ISSET($_POST['delete'])){
    ...
    $conn = new mysqli("localhost", 'root', '', 'pdmis') or die(mysqli_error());
           ...
           $conn->query ("UPDATE `employeeprofile` SET `username` = '', `password` = '', `transaction_a` = '', `patientprofile_a` = '', `employeeprofile_a` = '', `labtest_a` = '', `nephrologist_a` = '', `descriptors_a` = '', `userprofile_a` = '', `maintenance_a` = '', `reports_a` = '', `account` = '' WHERE `employeeprofile`.`employeeid` = '$employeeid';") or die(mysqli_error());
