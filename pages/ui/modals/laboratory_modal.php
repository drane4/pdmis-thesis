                                             ...
                                             <div role="tabpanel" class="tab-pane fade in" id="urinalysis">
                                                ...
                                                <div class="row clearfix">
                                                  ...
                                                  <div class="row clearfix">
                                                      <div class="col-lg-12 col-lg-offset-6">
                                                  <button type="button" class="btn btn-primary m-t-15 waves-effect" onclick="ClearFields();"> <i class="material-icons">description</i>Clear</button> &nbsp;
                                                            <button type="urinalysis" class="btn btn-primary m-t-15 waves-effect" name="urinalysis"><i class="material-icons">save</i>Save</button> &nbsp;
                                                        </div>
                                                  </div>
                                                 </form>
                                                  ...
                                                  <div class="row clearfix">
                                                      <div class="row clearfix">
                                                         ...
                                                         <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-control-label">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="date" id="dateothers" name="dateothers" class="form-control unstyled" placeholder="" value="<?php echo $fetch['Laboratory_date']?>" autofocus>
                                                                </div>
                                                         </div>
                                                    </div>
                                                         <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-control-label">
                                                         ...
                                                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-control-label">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" id="desc" name="desc" class="form-control" placeholder="" value="<?php echo $fetch['']?>" autofocus>
                                                                </div>
                                                        </div>
                                                         ...
                                                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-control-label">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" id="val" name="val" class="form-control" placeholder="" value="<?php echo $fetch['']?>" autofocus>
                                                                </div>
                                                        </div>
                                                    </div>
                                                  ...
                                                  <div class="row clearfix">
                                                      <div class="col-lg-12 col-lg-offset-6">
                                                  <button type="button" class="btn btn-primary m-t-15 waves-effect" onclick="ClearFields();"> <i class="material-icons">description</i>Clear</button> &nbsp;
                                                            <button type="others" class="btn btn-primary m-t-15 waves-effect" name="others"><i class="material-icons">save</i>Save</button> &nbsp;
                                                        </div>
                                                  </div>
                                                 </form>
