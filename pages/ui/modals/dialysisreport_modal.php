                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            ...
                                            <div class="body">
                                                <form class="form-horizontal page-content" form method="POST" action="report/dialysissummaryreport.php?id=<?php echo $H_id ?>">
                                                    <div class="row clearfix">
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <select class="form-control show-tick" data-live-search="true" name="patientid" id="patientid" title="&nbsp" required>
                                                    ...
                                                    <div class="row clearfix">
                                                       <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-3 col-xs-offset-3">
                                                            <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysissummary" style="width:80%; color:black" onclick="openDial()">Patient Dialysis Summary</button> <br>
                                                           <button type="submit" class="btn bg-grey m-t-15 waves-effect" name="dialysisdetail" style="width:80%; color:black">Patient Dialysis Detail</button> <br>
                                                        </div>
                                                    </div>
                                                </form>
...
<script>
            function openDial() {
                myWindow = window.open("print/dialysissummaryreport.php", "", "width=1350, height=650");
            }
