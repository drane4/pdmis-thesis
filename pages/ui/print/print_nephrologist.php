                            ...
                            <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <h4>HEMODIALYSIS NEPHROLOGIST PROFILE SHEET</h4>
                                               ...
                                               <div class="row clearfix">
                                <div class="col-xs-5">
                                        <strong> Nephrologist ID : <u><?php echo $fetch1['nephrologistid'] ?></u> 
                                        <br> Name : <u><?php echo $fetch1['n_fname'].' '.$fetch1['n_mname'].' '.$fetch1['n_lname']?></u>
                                        <br> Address: <u><?php echo $fetch1['n_address']?></u>
                                        <br> Telephone Number : <u> <?php echo $fetch1['n_telephone'] ?></u>
                                        <br> Mobile Number : <u> <?php echo $fetch1['n_mobile'] ?></u>
