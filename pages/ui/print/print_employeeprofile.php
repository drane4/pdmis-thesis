                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <h4>HEMODIALYSIS EMPLOYEE PROFILE SHEET</h4>
                                               ...
                                               <div class="row clearfix">
                                <div class="col-xs-5">
                                        <strong> Employee ID : <u><?php echo $fetch1['employeeid'] ?></u> 
                                        <br> Name : <u><?php echo $fetch1['firstname'].' '.$fetch1['middlename'].' '.$fetch1['lastname']?></u>
                                        <br> Address: <u><?php echo $fetch1['address']?></u>
                                        <br> Telephone Number : <u> <?php echo $fetch1['telnum'] ?></u>
                                        <br> Mobile Number : <u> <?php echo $fetch1['monum'] ?></u>
                                        <br> Position : <u> <?php echo $fetch1['position']?></u>
