...
ini_set('display_errors', 0);
   $pageid = $_GET[id];
   list($H_id ,$probdate2) = explode(" | ", $pageid);
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <h4>HEMODIALYSIS PATIENT PROBLEM LIST <?php echo $probdate?></h4>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <table id="mainTable" class="table table-bordered" style="margin-bottom: 0px; table-layout: fixed;">
                                                 ...
                                                 <tbody>
                                                            <?php         
                                                                   while($fetch = $problemquery2 ->fetch_array()){
                                                                ?>
                                                                <tr>
                                                                    <td>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-offset-9 col-xs-offset-9">
                                               <div class="row hidden-print mt-20">
                                                   ...
                                                   <button class="btn btn-primary btn-sm" onclick="location.href='../patientprofile.php?id=<?php echo $H_id." | "."problemlist"." | "."$probdate"?>'">cancel</button>
